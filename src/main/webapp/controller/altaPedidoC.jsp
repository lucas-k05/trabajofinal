...
Provincia provincia = new Provincia(Integer.valueOf(idProvincia), null);

Localidad localidad = new Localidad(Integer.valueOf(idLocalidad), null, provincia);
...
Boolean insertOk = dao.altaPedido(pedido);
if (insertOk) {
